...
function preload(){
  ...
  jumpimg=loadAnimation('png/Jump (1).png','png/Jump (2).png','png/Jump (3).png','png/Jump (4).png','png/Jump (5).png','png/Jump (6).png','png/Jump (7).png','png/Jump (8).png','png/Jump (9).png','png/Jump (10).png')
...
function setup(){
  ...
  playbutton.addAnimation("jumping",jumpimg);
  player.scale =0.23;
